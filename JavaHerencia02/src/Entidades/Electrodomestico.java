...
public class Electrodomestico {
    ...
    public Electrodomestico(Integer precio, String color, String consumoEnergetico, Integer peso, Integer precioFinal) {
        this.precio = precio;
        this.color = color;
        this.consumoEnergetico = consumoEnergetico;
        this.peso = peso;
        this.precioFinal = precioFinal;
        //comprobarConsumoEnergetico(Electrodomestico a1);
        
    }

    public Electrodomestico(Integer precioFinal) {
        this.precioFinal = precioFinal;
    }
...
//Electrodomestico a1 = new Electrodomestico();
    ...
    Scanner leer = new Scanner(System.in);
        ...
        a2.comprobarColor();
        a2.comprobarConsumoEnergetico(a2);
        ...
        System.out.println("el tamaño del electrodomestico es: " + a2.getPeso());
...
//        precioFinal = precioBase + precioP1 + a2.getPrecio();
    ...
    public String toString() {
        return "Electrodomestico{" + "precio=" + precio + ", color=" + color + ", consumoEnergetico=" + consumoEnergetico + ", peso=" + peso + ", precioFinal=" + precioFinal + '}';
    }
